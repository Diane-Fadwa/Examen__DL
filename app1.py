[2026-01-28, 13:43:39] ERROR - Task failed with exception: source="task"
AttributeError: 'SSHHook' object has no attribute 'run_command'
...
File "/opt/airflow/dags/repo/rattrapage/dag_rattrapage.py", line 103 in decompress_if_needed
...
with DAG(
    ...
    def process_file(contract_path: str, file_path: str):
        ...
        def decompress_if_needed(file_path: str) -> str:
            ...
            ssh_hook.exec_ssh_client_command(command=cmd)
