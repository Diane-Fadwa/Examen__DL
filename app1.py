...
with DAG(
    ...
    def process_file(contract_path: str, file_path: str):
        ...
        # Construire paths HDFS pour les artefacts
        ...
        @task
        def spark_ingest(artifact_paths):
            hdfs_file_path = file_path  # fichier déjà présent sur HDFS
