...
with DAG(
    ...
    def process_file(contract_path: str, file_path: str):
        ...
        def decompress_if_needed(file_path: str) -> str:
            ...
            # hcompressor ATTEND un chemin HDFS COMPLET
            machine_input_path = file_path
            machine_output_path = file_path.removesuffix(".zstd")
            ...
            logger.info("Décompression via hcompressor : %s", machine_input_path)
